        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <button type="button" class="btn btn-primary float-end mt-4 mb-4" data-bs-toggle="modal"
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                ...
                                                <a href="{{ route('user.destroy', $item->id) }}}}"
                                                    ...
                                                    data-bs-title="Hapus User"><i class="bi bi-trash3"></i></a>
                                                || <button data-bs-toggle="modal"
                                                    data-bs-target="#ubahPass{{ $item->username }}" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-title="Ubah Password"
                                                    class="btn btn-info" id="resetPass"><i
                                ...
                                <select name="role_id" id="status" class="form-select">
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{ $role->id }}"
                                            {{ $role->id == $item->role_id ? 'selected' : '' }}> {{ $role->name }}
                                        </option>
                                    @endforeach
