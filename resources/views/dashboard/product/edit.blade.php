            ...
            <section class="section">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('product.update', $product->id) }}" id="formProduct" method="POST">
                            @csrf
                            @method('put')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="inputSelling" value="N" type="radio"
                                        name="is_pajak" id="radioDefault1" {{ $product->is_pajak == 'N' ? 'checked' : '' }} >
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" id="inputBuying" type="radio" value="Y"
                                        name="is_pajak" id="radioDefault2" {{ $product->is_pajak == 'Y' ? 'checked' : '' }} >
    ...
    <script>
        $('.rupiah').number(true, 0);
          $('#formProduct').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('product.update', ':id') }}".replace(':id', '{{ $product->id }}'),
                type: 'POST',
                data: formData,
                beforeSend: function() {
