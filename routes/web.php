...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('product')->group(function () {
        ...
        Route::get('/dashboard/product-datatable', [ProductController::class, 'datatables'])->name('product.datatable');
        Route::post('/dashboard/product-add', [ProductController::class, 'store'])->name('product.store');
        Route::get('/dashboard/product-edit/{slug}', [ProductController::class, 'edit'])->name('product.edit');
        Route::put('/dashboard/product-edit/{slug}', [ProductController::class, 'update'])->name('product.update');
        Route::get('/dashboard/product-delete/{slug}', [ProductController::class, 'destroy'])->name('product.destroy');
    });

    // product-in
    Route::get('/dashboard/productIn', [ProductInController::class, 'index'])->name('product.in');
    Route::post('/dashboard/productIn-add', [ProductInController::class, 'store'])->name('product.in.store');
    Route::get('/dashboard/historyProduct/{slug}', [ProductInController::class, 'show'])->name('product.in.history');
    Route::get('/dashboard/productIn-delete/{slug}', [ProductInController::class, 'destroy'])->name('product.in.destroy');
